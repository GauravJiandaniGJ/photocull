...
- Public repo (MIT): `README.md` is the front door, `docs/ARTICLE.md` is the Medium write-up and `docs/images/` holds its figures (rendered from HTML/mermaid sources kept out of the repo; phone screenshots are cropped above any photo thumbnails). Keep phone names and UDIDs out of committed files.
